...
export function PlacListingDetail() {
  ...
  const displayYear = listing ? normalizePlacYear(listing.year) : null;
  const displayFormat = listing ? formatPlacListingFormat(listing.format) : null;
        ...
        <article className="plac-detail card">
          <div className="plac-detail-layout">
            ...
            <div className="plac-detail-body">
              ...
              {displayFormat && <p className="muted fine">{displayFormat}</p>}
